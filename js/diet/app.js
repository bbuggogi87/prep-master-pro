...
import {
    ...
    toggleCollapse, updateMealField, updateItemName, updateItemAmount, deleteItem, duplicateItem, addItem, deleteMeal, duplicateMeal, calculateMacros,
    moveMealOrder, togglePhaseSummary, exportDietPlanToExcel, importDietPlanFromExcel
} from './dietPlanner.js';
...
// [빠른 설정 패널] ⚡세트입력/⏰수동알람 하위 패널은 원래 calendar.html 전용이던 workoutJournal.js/
// restTimerEngine.js의 함수를 그대로 재사용한다(화면 전환 없이 식단 화면에서도 바로 세트 등록·타이머 가동).
import {
    openQuickSettingsPanel, closeQuickSettingsPanel, toggleQuickAccordion, saveQuickInputFABModal,
    setQuickAlarmSec, startQuickAlarm,
} from '../workout/workoutJournal.js';
import { stopRestTimer, extendRestTimer } from '../workout/restTimerEngine.js';
...
window.togglePhaseSummary = togglePhaseSummary;
window.exportDietPlanToExcel = exportDietPlanToExcel;
window.importDietPlanFromExcel = importDietPlanFromExcel;
